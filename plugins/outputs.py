...
# observer so subscribes to telemetry subject and drives the live display
class RealTimeDashboard:
    ...
    def run(self, telemetry):
        ...
        show_int = tel_cfg.get('show_intermediate_stream', False)
        ...
        def animate(frame):
            ...
            all_bars = [
                ...
                ('verified queue',self.verified_size,show_int and self.verified_size >= 0,  1.3),
            ...
            # update each chart line in-place
            for i, chart_cfg in enumerate(charts):
                ax = chart_axes[i]
                line = chart_lines[i]
                ...
                # only thing that changes on the title
